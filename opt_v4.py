...
###########################################################################
### V4: All feeds & allow all cell to be converted to grain ###
###########################################################################
...
def scoring(feats, optimisation_method, gap_reduce, lam, me_to_meat, logger):
    ...
    for l in ['stover']:
        ...
        feats[l+'_trans_cost'] = ntrips_beef_mkt * feats[['ADM0_A3']].merge(fuel_cost[['ADM0_A3', 'Diesel']],
                                                                   how = 'left',
                                                                   left_on = 'ADM0_A3',
                                                                   right_on ='ADM0_A3')['Diesel'].values * \
                                 feats["accessibility"] * fuel_efficiency/1000.
    ...
    ############################## Carbon stock for current beef to no beef ###################
...
def trade(feats, optimisation_method, lam):
    ...
    for l in landuses:
        ...
        feats[l + '_trans_cost'] = ntrips * feats["distance_port"] * feats[['ADM0_A3']].merge(fuel_cost[['ADM0_A3', 'Diesel']],
                                                                   how = 'left',
                                                                   left_on = 'ADM0_A3',
                                                                   right_on ='ADM0_A3')['Diesel'].values  * fuel_efficiency/ 1000.
